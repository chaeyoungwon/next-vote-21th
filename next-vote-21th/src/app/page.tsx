    ...
    <div className="relative min-h-screen w-screen overflow-x-hidden">
      <div className="flex h-screen flex-col items-center pt-16">
        ...
        <div className="mt-[91px] flex w-full flex-col items-center justify-center gap-4 max-md:pb-16 md:mt-[67px]">
          <button onClick={handleClick} className="text-heading2 border-violet bg-violet-light text-violet-pressed hover:border-violet-dark hover:bg-violet hover:text-gray-0 shadow-button h-12 w-fit cursor-pointer rounded-3xl border px-[26px] py-[11px] md:h-[54px] md:px-[21px] md:py-[9px] md:text-2xl">
            투표하러 가기
          </button>
